...
class Race extends Component {
    ...
    createEnemy() {
        var { state } = this,
            ...
            animationEnd = true;
        setInterval( () => {
            if( state.aniEnd && state.gameState === 1 ) {
                this.setState({
                    aniEnd: false
                });
    ...
    render() {
        ...
        return <div className={boardCls}>
            ...
            <div className="failbub">
                ...
                <span className="retry" onClick={this.gameRestart.bind(this)}></span>
            </div>
        </div>
    }
    ...
    /*render() {
        ...
        return (
            <div className={boardCls}>
                <div className={state.gameStart==1?"roadbed roadRun":"roadbed"}></div>
                <div className={state.gameStart==1?"road roadPlay":"road"}>
                    <div className={"hero " + (state.heroLoc ? 'right' : 'left')}></div>
                ...
                <span className={"start" + (state.gameState ? ' hide' : '')}
...
render(
    <Race />,
    document.getElementById('page-race')
);
